...
# 스타트노드부터 각 노드까지의 최소거리 = 각 노드에서 스타트노드까지의 최소거리
# 스타트노드부터 각 노드까지의 최소거리를 DP에 업데이트해줌
...
def Dijkstra(start):
    ...
    dp[start] = 0
    heapq.heappush(heap,(0, start)) # (wei, node)
